...
public class WebDesignerLoginAuthenticator extends FormAuthenticator {
	...
	public WebDesignerLoginAuthenticator(String login, String error,
			boolean dispatch) {
	...
	@Override
	public UserIdentity login(String username, Object password,
	...
	public Authentication validateRequest(ServletRequest req,
			ServletResponse res, boolean mandatory) throws ServerAuthException {
		...
		if (isLoginOrErrorPage(URIUtil.addPaths(request.getServletPath(),
				request.getPathInfo())) && authentication != null) {
			try {
