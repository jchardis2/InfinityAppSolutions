package com.infinityappsolutions.server.lib.webvideo.exceptions;

public class WebVideoException extends Exception {
	 ...
	 */
	public WebVideoException(String message) {
