package com.infinityappsolutions.server.webvideo.views;
...
import com.infinityappsolutions.server.webvideo.actions.VideoAction;
...
public class VideoView implements Serializable {
	...
	private ArrayList<VideoBean> getCheckedVideos() {
