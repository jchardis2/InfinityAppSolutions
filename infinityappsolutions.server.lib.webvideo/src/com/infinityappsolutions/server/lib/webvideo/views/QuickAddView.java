...
public class QuickAddView implements Serializable {
	...
	public String HOME_URL = "home.infinityappsolutions.com/video/";
	public String HOME_DIR = "/media/jchardis/BigDaddy/videos";
	...
	public String quickAdd() {
		...
		while (scan.hasNextLine()) {
			...
			video.setName(name);
			video.setType("HD");
			String url = HOME_URL + line;
			url = URIUtil.encodePath(url);
			video.setUrl(url);
			String filename = HOME_DIR + line;
